...
<div class="container">
    ...
    <div class="row">
     {{--   <form method="post" action="/api/file/downloadfile1">--}}
        <form method="post" action="/api/file/downloadfile">
...
<script type="text/javascript">
    function One() {
      //  document.form.action = "/api/file/downloadfile";
        document.form.action = "/aetherupload/example_source";
...
<script>
    ...
    someCallback = function(){
        // Example
        $('#result').append(
            '<p>文件名：<span >'+this.fileName+'</span>  <br>文件大小：<span >'+parseFloat(this.fileSize / (1000 * 1000)).toFixed(2) + 'MB'+'</span>  <br>哈希加密后文件名：<span >'+this.savedPath.substr(this.savedPath.lastIndexOf('/') + 1)+'</span></p>'
        );
    }
</script>
</body>
